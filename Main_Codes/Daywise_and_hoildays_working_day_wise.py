...
#workingdays
fraction1={"d11":0,"d22":0,"d33":0,"d44":0,"d55":0,"j11":0,"j22":0,"j33":0,"j44":0,"j55":0,
...
#tick_label does the some work as plt.xticks()
plt.bar(range(len(data)),violations,tick_label=weekdays)
plt.savefig("D:\\cop\\cmps_trfc_mon1\\cmps_trfc_mon\\Data\\holiday_trafficvariation.png")
plt.show()
...
#tick_label does the some work as plt.xticks()
plt.bar(range(len(data)),violations,tick_label=weekdays)
plt.savefig("D:\\cop\\cmps_trfc_mon1\\cmps_trfc_mon\\Data\\holiday_traficviolation.png")
plt.show()
...
#tick_label does the some work as plt.xticks()
plt.bar(range(len(data)),violations,tick_label=weekdays)
plt.savefig("D:\\cop\\cmps_trfc_mon1\\cmps_trfc_mon\\Data\\working_violationvstraffic.png")
plt.show()
...
#tick_label does the some work as plt.xticks()
plt.bar(range(len(data)),violations,tick_label=weekdays)
plt.savefig("D:\\cop\\cmps_trfc_mon1\\cmps_trfc_mon\\Data\\weekends_violationvstraffic.png")
plt.show()
